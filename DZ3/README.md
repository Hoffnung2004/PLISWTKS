...
![Альтернативный текст](Screenshot(674).png)  
...
![Альтернативный текст](Screenshot(677).png)  
Спектры референсной формы синуса, зашумлённого синуса и шума. (Цвета теже)  
![Альтернативный текст](Screenshot(680).png)  
...
![Альтернативный текст](Screenshot(679).png)  
